...
def parse_args(args):
    ...
    parser.add_argument('--score-threshold',  help='Threshold on score to filter detections with (defaults to 0.01).', default=0.01, type=float)
...
def main(args=None):
    ...
    if args.convert_model:
        model = models.convert_model(model, anchor_params=anchor_params, iou_threshold=args.iou_threshold, score_threshold=args.score_threshold)
