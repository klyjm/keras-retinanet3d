...
class Backbone(object):
    ...
    def __init__(self, backbone):
        ...
        self.custom_objects = {
            ...
            '_giou'            : losses.diou_loss(),
            '_ciou'            : losses.ciou_loss(),
            '_focal'           : losses.focal(),
            'keras'            : keras
        }
...
def convert_model(model, nms=True, class_specific_filter=True, anchor_params=None, iou_threshold=0.5, score_threshold=0.05):
    ...
    return retinanet_bbox(model=model, nms=nms, class_specific_filter=class_specific_filter, anchor_params=anchor_params, iou_threshold=iou_threshold, score_threshold=score_threshold)
