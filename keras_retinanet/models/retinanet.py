...
def default_classification_model(
    ...
    # outputs = keras.layers.Lambda(lambda x: keras.backend.expand_dims(x, axis=1))(outputs)
    # outputs = keras.layers.ConvLSTM2D(
...
def default_regression_model(num_values, num_anchors, pyramid_feature_size=256, regression_feature_size=256, name='regression_submodel'):
    ...
    outputs = keras.layers.Lambda(lambda x: keras.backend.expand_dims(x, axis=1))(outputs)
    outputs = keras.layers.ConvLSTM2D(num_anchors * num_values, name='pyramid_regression', **options)(outputs)
    if keras.backend.image_data_format() == 'channels_first':
...
def retinanet_iou(
    ...
    **kwargs
    ...
    # construct the model
    # return keras.models.Model(inputs=model.inputs, outputs=detections, name=name)
    return keras.models.Model(inputs=model.inputs, outputs=concatenated_top, name=name)