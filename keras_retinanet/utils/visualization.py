...
def draw_caption(image, box, caption):
    ...
    """
    b = np.array(box).astype(int)
    cv2.putText(image, caption, (b[0] - 5, b[1] - 10), cv2.FONT_HERSHEY_PLAIN, 1, (0, 0, 0), 2)
    cv2.putText(image, caption, (b[0] - 5, b[1] - 10), cv2.FONT_HERSHEY_PLAIN, 1, (255, 255, 255), 1)
...
def draw_detections(image, boxes, scores, labels, color=None, label_to_name=None, score_threshold=0.5):
    ...
    for i in selection:
        ...
        draw_box(image, boxes[i, :], color=c, thickness=int(0.6 * 1024 / 600))
...
def draw_annotations(image, annotations, color=(0, 255, 0), label_to_name=None):
    ...
    for i in range(annotations['bboxes'].shape[0]):
        ...
        draw_box(image, annotations['bboxes'][i], color=c, thickness=int(0.6 * 1024 / 600))
